 ...
 */
$.fn.Mcal = function (options, callback) {
  let style =
  ...
  let $cal = $(
    '<div class="Mcal"><div class="Mcal-year"><div class="btn-year pre-year"></div><span class="year">2018</span>年<div class="btn-year next-year"></div></div><ul class="Mcal-Months"><li data-val="01" class="month-item"><span>1月</span></li><li data-val="02" class="month-item"><span>2月</span></li><li data-val="03" class="month-item"><span>3月</span></li><li data-val="04" class="month-item"><span>4月</span></li><li data-val="05" class="month-item"><span>5月</span></li><li data-val="06" class="month-item"><span>6月</span></li><li data-val="07" class="month-item"><span>7月</span></li><li data-val="08" class="month-item"><span>8月</span></li><li data-val="09" class="month-item"><span>9月</span></li><li data-val="10" class="month-item"><span>10月</span></li><li data-val="11" class="month-item"><span>11月</span></li><li data-val="12" class="month-item"><span>12月</span></li></ul></div>'
  ) //日历面板
  let $year = $cal.find('.year')
  let $month = $cal.find('.month-item')
  let $input = this
  let cur_year = new Date().getFullYear() //当前时间年份
  let cur_month = new Date().getMonth() //当前时间月份
  let show_year = cur_year //当前选择的年份
  let needPosition = true
  let show_month = cur_month //当前选择的月份
  ...
  $month.click(function () {
    ...
    if (typeof options.onChange == 'function') {
      options.onChange.call($input, [show_year, show_month])
    }
  })
  //设置禁止点击
  ...
  $(document).click(function (e) {
    if (!$(e.target).closest('#date').length && $(e.target).closest('.Mcal').length == 0) {
      $cal.slideUp(200)
    }
  })
}
